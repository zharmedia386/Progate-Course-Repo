...
if money > total_price :
  print('You have bought ' + str(count) + ' apples' + 'You have ' + str(total_price-money) + ' dollars left')
elif money == total_price :
  print('You have bought ' + str(count) + ' apples' + 'Your wallet is now empty')
else :
  print('You do not have enough money '  + ' You cannot buy that many apples')